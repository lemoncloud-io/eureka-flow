...
export const GUIDE_TOUR_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        arrowDirection: 'left',
        visual: { type: 'icon', element: null }, // Will render sidebar screenshot
    },
    {
        id: 'flow-info',
        title: '플로우 정보 및 상태',
        ...
        arrowDirection: 'top',
        visual: { type: 'icon', element: null }, // Will render header screenshot
    },
    {
        id: 'quick-actions',
        title: '빠른 작업',
        ...
        arrowDirection: 'top',
        visual: { type: 'icon', element: null }, // Will render toolbar screenshot
    },
    {
        id: 'main-menu',
        title: '메인 메뉴',
        ...
        arrowDirection: 'top',
        visual: { type: 'icon', element: null }, // Will render menu screenshot
    },
    {
        id: 'ready',
        title: '준비 완료!',
