 ...
 * `post` mock that returns canned data in memory without a network round trip: production
 ...
 * env-gated on a real provider key. The real-*backend* proof (this browser gateway against a deployed
