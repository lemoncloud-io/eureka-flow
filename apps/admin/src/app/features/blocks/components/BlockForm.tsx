...
export const BlockForm = ({ data, onChange }: BlockFormProps) => {
    ...
    return (
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2">
                <Label>Icon</Label>
                <Input value={data.icon} onChange={e => update('icon', e.target.value)} className="w-20" />
            </div>
            <div className="flex flex-col gap-2">
                <Label>Stereo</Label>
                <Select value={data.stereo} onValueChange={v => update('stereo', v as BlockFormData['stereo'])}>
                    <SelectTrigger>
                        <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
            ...
            <div className="flex flex-col gap-2">
                ...
                <Input value={data.processType} onChange={e => update('processType', e.target.value)} />
            </div>
            <div className="flex flex-col gap-2">
                <Label>Order</Label>
                <Input
            ...
            <div className="flex items-center gap-2">
                <Switch checked={data.isFrontend} onCheckedChange={v => update('isFrontend', v)} />
