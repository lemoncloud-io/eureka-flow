...
export const BUILDER_SYSTEM_PROMPT = [
    ...
    '  values. If a value is not allowed, a field does not exist, or a connection is rejected, do NOT invent a',
    '  substitute or force it — report what was rejected; whoever briefed you decides.',
