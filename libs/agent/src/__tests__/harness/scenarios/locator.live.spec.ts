 ...
 * orchestrator-level live eval is integration.live.spec.ts.
 *
 ...
 *   RUN_LIVE=1 npx vitest run libs/agent/src/__tests__/harness/scenarios/locator.live.spec.ts -t ambiguous
...
describe.skipIf(SKIP_LIVE)('Locator — LIVE against a real Gemini key', () => {
    it(
