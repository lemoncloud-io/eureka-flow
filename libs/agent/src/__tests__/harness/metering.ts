...
/**
 * Metering — the eval efficiency axis (evaluation.md §6). Provider-neutral,
...
/**
 * Rates WE own (evaluation.md §6) — raw tokens are the ground-truth axis; these only scale the
